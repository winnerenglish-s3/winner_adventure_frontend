            ...
            <div class="col-12 bg5 br-tr-sm br-br-sm br-bl-sm q-pa-sm">
              ...
              >
                ...
                <q-tab-panel name="practice">
                  ...
                  <div class="text-h6">
                    <div class="q-mt-lg">
                      <span v-html="readingContent.contentEng"></span>
                    </div>
                  </div>
                </q-tab-panel>
  ...
  data() {
    return {
      ...
      practice: {
        ...
        currentSentence: 0, // ข้อประโยตปัจจุบัน
        currentExtraVocab: 0, // เปลื่ยนหน้า vocab
        instructionTH: "",
        instructionEN: ""
      },
      currentPage: "",
      ...
      isDisabled: false, // ปิดการใช้งานปุ่ม
      isAnswer: false, // true = ตอบคำถามแล้ว, false = ยังไม่ตอบคำถาม
      isShowDescription: false, // โชว์คำอธิบาย

      isCheckAnswer: false,
      isFinish: false, // จบแบบฝึกหัด

      isShowStoryContent: false,
